...
{#snippet nav_content()}
	...
	<li><a href="/weekend/{lastFriday.toISOString().split('T')[0]}">Weekend</a></li>
	<li><a href="/screen">Screen</a></li>
	<li><a href="/market_share">Market Share</a></li>
	<li>
	...
	<SearchMovie
		select_function={(result) => goto(`/m/${result.id}`)}
		clear_results={true}
		respond_to_command_slash={true}
	/>
...
<!-- using copilot now, I want gpt 5 -->
...
<div class="navbar bg-base-100 shadow-sm">
	<div class="navbar-start">
		...
		<a class="btn btn-ghost text-xl" href="/recent">Reel Numbers</a>
	</div>
	...
	<div class="navbar-end">
		<!-- Source Code Link -->
		<a href="/settings" class="hidden lg:inline-flex">
